    ...
    <section className="min-h-screen flex flex-col justify-center items-center py-20 md:py-24 bg-background text-foreground">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          <Card 
            className="bg-card border-border/50 shadow-xl p-8 aspect-[3/2] flex justify-center items-center opacity-0 animate-fade-in-up rounded-lg" // Adjusted to match image
