      ...
      <div className="container mx-auto px-4 text-center">
        <div className="flex justify-center items-center">
          ...
          <div className="flex-grow">
            ...
            <div 
              className="relative max-w-4xl mx-auto aspect-[16/10] bg-card border border-border/30 rounded-xl shadow-2xl p-1.5 opacity-0 animate-fade-in-up transition-all duration-300 hover:shadow-primary/30"
