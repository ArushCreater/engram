  ...
  return (
    <section className="relative py-16 md:py-24 bg-secondary text-foreground overflow-hidden">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-12">We're running out of Time</h2>
        ...
        <div className="relative z-10 flex flex-col items-center space-y-6">
          ...
          >
            {isOn ? <ToggleRight className="h-16 w-16 text-primary" /> : <ToggleLeft className="h-16 w-16 text-muted-foreground" />}
          </Button>
        </div>
      </div>
    </section>
